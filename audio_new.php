...
<li><a href="#">Manage Passowrd</a></li>
...
<div class='well2'>
	<ul class="menu_throw">
	<li>Audios <span class='lebel'>100</span></li>
...
<pre>
   <div class="add_audio">
   	...
   	<tr>
   		<td><input type="text" placeholder="Audio Topic" name="audio_title"></td>
